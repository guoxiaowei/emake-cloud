...
(function ($) {
    ...
    $.fn.fileinputLocales['cz'] = {
        ...
        msgSizeTooLarge: 'Soubor "{name}" (<b>{size} KB</b>): překročení - maximální poemakená velikost <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Musíte vybrat nejméně <b>{n}</b> {files} pro nahrání.',
        msgFilesTooMany: 'Počet vybraných souborů pro nahrání <b>({n})</b>: překročení - maximální poemakený limit <b>{m}</b>.',
