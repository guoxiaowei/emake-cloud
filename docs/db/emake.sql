...
-- ----------------------------
BEGIN;
INSERT INTO `member_0` VALUES (1067629916525072386, 'emake', '{bcrypt}$2a$10$YCnmdlVnNsXdxR8t7glNeO5lPlDpbEijuFHrkcT13KcbqXsEVUqAC', '18512582267', NULL, '2018-11-28 12:02:52', NULL, '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `oauth_client_details` VALUES (1, 'emake', NULL, '{bcrypt}$2a$10$zqgaMTf2VSHXjIV28CrID.fgN1bGd73VTwLqvmTqHNak79nrRNz7W', 'server', 'client,password', NULL, NULL, NULL, NULL, NULL, 'true');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_zuul_route` VALUES (3, '/demo/**', 'emake-demo', '', '1', '1', '1', '', '2018-05-17 14:09:06', '2018-12-03 15:15:59', '0');
INSERT INTO `sys_zuul_route` VALUES (4, '/mps/**', 'emake-mps', '', '1', '1', '1', '', '2018-05-21 11:40:38', '2018-12-03 15:16:16', '0');
INSERT INTO `sys_zuul_route` VALUES (5, '/auth/**', 'emake-auth', '', '1', '1', '1', '', '2018-05-21 11:41:08', '2018-10-29 21:25:46', '0');
COMMIT;
