...
public class EmakeMonitorApplication {

    public static void main(String[] args) {
        log.debug("EmakeMonitorApplication startup main");
        SpringApplication application = new SpringApplication(EmakeMonitorApplication.class);
