package com.emake.gateway.service.impl;

import com.emake.gateway.entity.vo.PermissionVO;
import com.emake.gateway.feign.RemotePermissionService;
import com.emake.gateway.service.EmakePermissionService;
...
@Slf4j
@Service("emakePermissionService")
public class EmakePermissionServiceImpl implements EmakePermissionService {
    @Autowired
