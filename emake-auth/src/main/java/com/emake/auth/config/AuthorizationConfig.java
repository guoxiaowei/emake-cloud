package com.emake.auth.config;

import com.fasterxml.jackson.annotation.JsonTypeInfo;
import com.fasterxml.jackson.databind.MapperFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.emake.auth.util.jackson2.AuthJackson2Module;
import com.emake.auth.util.UserDetailsImpl;
import com.emake.common.constants.CommonConstant;
import com.emake.common.constants.SecurityConstants;
...
public class AuthorizationConfig extends AuthorizationServerConfigurerAdapter {
     ...
     *
     * @return TokenStore
     * 1. 如果使用的 redis-cluster 模式请使用 EmakeRedisTokenStore
     * EmakeRedisTokenStore tokenStore = new EmakeRedisTokenStore();
     * tokenStore.setRedisTemplate(redisTemplate);
     */
    @Bean
    public TokenStore redisTokenStore() {
        //EmakeRedisTokenStore tokenStore = new EmakeRedisTokenStore(redisConnectionFactory);
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            ...
            additionalInfo.put("license", SecurityConstants.Emake_LICENSE);
