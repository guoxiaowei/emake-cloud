...
public class HttpSessionConfig {
     ...
     * 每个会话"emake-session:session:sessions: XXX"是一个Hash数据结构，可以用Redis HASH相关的命令来查看
     * 查看会话key
     * hgetall emake-session:session:sessions:20e6b651-bd4d-4402-bb00-3400055e36ea
     * 查看该会话里的user1信息
     * HMGET "emake-session:session:sessions:20e6b651-bd4d-4402-bb00-3400055e36ea"   sessionAttr:user1
